# Claim–Evidence Table — ≠ME「愛くださいませ」

- 基準日: 2026-09-05
- Confidence: High＝一次資料で直接確認、Medium＝複数資料の一致または一次事実からの限定分析、Low＝二次資料・機械推定・批評仮説。
- Public use: Yes＝事実として使用可、Qualified＝留保を付ければ使用可、Analysis＝分析／解釈と明示して使用、No＝現時点では不使用。

| ID | 区分 | Claim | Evidence | Source IDs | Confidence | 反証・留保 | Public use |
|---|---|---|---|---|---|---|---|
| CE-001 | Fact | 本曲は12th両A面シングルの全4形態M1として2026-06-24発売 | 公式特設・収録内容 | S01, S02 | High | なし | Yes |
...
| CE-012 | Fact | 初披露・MVは菅波美玲を除く11名、公式設計はセンター概念なし | レーベル記事・公式MV説明 | S05, S11 | High | 二次資料の冨田センター表記と衝突。公式を採用 | Yes |
| CE-013 | Fact | 公式は本曲を≠ME史上最高難度のダンスと説明 | レーベル記事・公式MV説明 | S05, S11 | High | 客観的測定値ではなく公式評価 | Qualified |
| CE-014 | Fact | akaneは繊細さ、呪いの残存感、同期、視線、静寂を振付意図として説明 | 振付師コメント掲載の公式記事 | S12 | High | なし | Yes |
...
| CE-022 | Analysis | 傷と宝飾の語彙が結ばれ、美しさと損傷が同時化される | 痣・棘・涙／ドレス・薔薇・宝石等 | S22 | Medium | 批評的整理 | Analysis |
| CE-023 | Analysis | センターなしは焦点の消失ではなく、場面ごとの焦点移動と主体分散を生む | 公式センター方針、4＋7配役、振付コメント | S05, S11, S12 | Medium | 全編隊形ログ未取得 | Analysis |
| CE-024 | Fact | ライブ初披露→配信→MV→TV→ダンス映像→THE FIRST TAKEの順に入口が増えた | 公式公開日一覧 | S03, S05–S12, S23–S25, S38–S39 | High | 施策効果の因果は未証明 | Yes |
| CE-025 | Fact | THE FIRST TAKE #691はグループ初登場、APAZZIの特別リアレンジ | 公式告知・レーベル記事 | S23–S26 | High | なし | Yes |
| CE-026 | Fact | THE FIRST TAKE版も通常版と同じ演奏陣を起用 | 編曲者・演奏者発信 | S14, S16, S17, S26, S27 | High | 個別テイクの録音日等は未公表 | Yes |
| CE-027 | Analysis | 通常版は群舞、THE FIRST TAKE版は声の精度を前景化する | 公式形式と冨田コメント | S23–S27 | Medium | 音響差の詳細分析は未完 | Analysis |
| CE-028 | Fact | Billboard Top Singles Sales初週431,769枚で1位、3作連続自己最多更新 | Billboard JAPAN | S31 | High | 集計期間を併記 | Yes |
| CE-029 | Fact | Oricon週間シングル初週31.0万枚、3作連続・通算5作目1位 | Oricon | S34 | High | Billboardと集計基準が異なる | Yes |
| CE-030 | Fact | Hot 100は94位から発売週1位となりグループ初総合首位 | Billboard JAPAN | S32 | High | 発売週の総合順位 | Yes |
| CE-031 | Fact | Hot 100は翌週42位、次週74位 | 二次分析＋公式チャート | S47, S48 | Medium | 翌週42位は二次媒体経由 | Qualified |
...
1. Yesは通常の事実記述に使えるが、必要な日付・集計期間・主体を落とさない。
2. Qualifiedは「公式発表によれば」「機械推定では」「観測時点で」等の限定を必ず付ける。
3. Analysisは「〜と読める」「〜と分析できる」と記し、Factの文法で書かない。
4. NoはPublic Reportの確定記述に使わず、必要なら「未確認」としてのみ触れる。
